...
()=>(0,b.switchTab)(f(d),e))})};b.init=()=>{Object.keys(k.p.tab).forEach(e=>{b.setupTabs(e)});Object.keys(k.p.tab).forEach(e=>{b.switchTab(k.p.tab[e],e)})}})(ha||={});var Ha=ha,Ia=(b=!0)=>{b&&k.load();document.getElementById("preshit").style.display="none";document.getElementById("game").style.display="";N.unlocks();v.init();z.init();Ea();la();M.init();N.init();Ga.init();Ha.init();E.init();y.init();Fa()};document.addEventListener("DOMContentLoaded",()=>Ia())})();
